...
src/catalog.cpp \
src/location.cpp \
src/commands/create_product_command.cpp \
src/commands/delete_product_command.cpp \
src/commands/check_store_product_quantity_command.cpp \
src/commands/update_product_name_command.cpp \
src/commands/update_product_price_command.cpp \
src/commands/update_product_description_command.cpp \
src/commands/update_product_supplier_id_command.cpp \
src/commands/get_product_name_command.cpp \
src/commands/get_product_price_command.cpp \
src/commands/get_product_description_command.cpp \
